...
export default function NewProductPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold mb-8 text-gray-900">افزودن محصول جدید</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow p-8 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">قیمت با تخفیف (اختیاری)</label>
